...
The [return data](./about.mdx) of the calling context is set as the given chunk of memory of this context.

## Stack input

0. `offset`: byte offset in the [memory](./about.mdx) in bytes. The return data of the calling context.
