...
The **RJUMPI** instruction may alter the program counter with relative offset, thus breaking the linear path of the execution to another point in the deployed [code](./about.mdx). It is used to implement functionalities like loops and conditions.
...
0. `relative_offset`: 2-byte relative offset in the deployed [code](./about.mdx) where execution will continue from.
