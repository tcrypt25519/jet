...
The **JUMP** instruction alters the program counter, thus breaking the linear path of the execution to another point in the deployed [code](./about.mdx). It is used to implement functionalities like functions.
