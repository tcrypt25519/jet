// Globals
pub const JIT_ENGINE: &str = "jet.jit_engine";
...
pub const FN_STACK_PEEK: &str = "jet.stack.peek";
pub const FN_STACK_SWAP: &str = "jet.stack.swap";
...
pub const FN_MULMOD: &str = "jet.ops.mulmod";
